...
public class BackupServiceImpl implements BackupService {
    @Override
    public boolean executarBackup(String tipoBanco, String host, int porta, String usuario, String senha, String nomeBanco, File destino, String tipoBackup, boolean comprimir) throws Exception {
        DatabaseConnector connector = getConnector(tipoBanco, host, porta, usuario, senha, nomeBanco);
        return connector.realizarBackup(destino, tipoBackup, comprimir);
    }
